...
CREATE TABLE `categoria` (
  ...
  `temIsencao` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `itemVenda` (
  ...
  CONSTRAINT `itemVenda_FK` FOREIGN KEY (`id_venda`) REFERENCES `itemVenda` (`id`),
...
CREATE TABLE `produto` (
  ...
  `preco` double NOT NULL,
  `pesoEmbalagem` varchar(10) DEFAULT NULL,
...
-- Dump completed on 2023-10-30 20:21:43
